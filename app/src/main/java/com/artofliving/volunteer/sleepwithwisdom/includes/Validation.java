...
public class Validation {
	...
	private static final String NAME_REGEX = "[a-zA-Z '._-]*";
	...
	// call this method when you need to check for simple name (like name, city etc)
	public static boolean isNormalText(EditText editText, boolean required) {
